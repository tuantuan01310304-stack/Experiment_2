...
def generate_launch_description():
    ...
    # 机器人生成在桌面上（z=0.75 与 lws_transfer_params.yaml 的 base_pose_xyz 一致）
    spawn = Node(
    ...
    grasp = Node(
        package='mecharm_grasp_lws', executable='lws_transfer_task',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('world', default_value='lws_transfer_world.sdf'),
        DeclareLaunchArgument('params', default_value='lws_transfer_params.yaml'),
        resource_env,
        gz_gui, gz_headless,
