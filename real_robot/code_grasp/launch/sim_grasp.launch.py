...
def generate_launch_description():
    ...
    # 机器人生成在桌面上（z=0.75 与 grasp_params.yaml 的 base_pose_xyz 一致）
    spawn = Node(
    ...
    grasp = Node(
        package='mecharm_grasp_lws', executable='grasp_task',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('world', default_value='grasp_world.sdf'),
        DeclareLaunchArgument('params', default_value='grasp_params.yaml'),
        resource_env,
        gz_gui, gz_headless,
